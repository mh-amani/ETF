...
class TestPrefixAllowedTokenFn(unittest.TestCase):
    def setUp(self):
        ...
        self.linearization_class_id = "fully_expanded_et"
        ...
        self.sentences = [
            ...
            # Mid of end of triplet tag
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et")[:-1],
            # End of triplet tag
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et]")[:-1],
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et] [")[:-1],
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et] [s")[:-1],
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et] [s]")[:-1],
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et] [s]")[:-1] + [726],
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et] [s]")[:-1] + [726, 250, 1343],
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et] [s] AlAq [")[:-1],
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et] [s] AlAq [r")[:-1],
            tokenizer.encode(" [s] AlAq [r] date of birth [o] AlAq [et] [s] AlAq [r]")[:-1],
        ]
